      ...
      <div class="modal-content">
        <div class="modal-body">
          <div class="login-div" v-show="MODAL_STATUS === STATUS_LOGIN">
            ...
            <div  v-on:click="login()" class="form-group">
            ...
            <div class="form-group">
              <div class="input-group">
                <input  v-on:blur="onRegisterMobileCodeBlur()"
                     ...
                     placeholder="手机验证码" v-model= "memberRegister.smsCode"><!--  //code改为smsCode-->
          ...
          <div class="forget-div" v-show="MODAL_STATUS === STATUS_FORGET">
            ...
            <div class="form-group">
              <input v-on:blur="onForgetMobileBlur()"
                     ...
                     class="form-control" placeholder="手机号">
              <span v-show="forgetMobileValidate === false" class="text-danger">手机号11位数字，且必须已注册</span>            </div>
            <div class="form-group">
              <div class="input-group">
  ...
  export default {
    ...
    methods: {
      ...
      onRegisterMobileCodeBlur () {
        let _this = this;
        _this.registerMobileCodeValidate = Pattern.validateMobileCode( _this.memberRegister.smsCode);//code改为smsCode
        return _this.registerMobileValidate;
      },
