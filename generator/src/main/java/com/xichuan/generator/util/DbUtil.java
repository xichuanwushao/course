...
public class DbUtil {
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            String url = "jdbc:mysql://localhost:3306/coursedev";
            String user = "coursedev";
            String pass = "qweqwe";
     ...
     * @throws Exception
     */
    public static List<com.xichuan.generator.util.Field> getColumnByTableName(String tableName) throws Exception {
        List<com.xichuan.generator.util.Field> fieldList = new ArrayList<>();
        Connection conn = getConnection();
        Statement stmt = conn.createStatement();
        ...
        if (rs != null) {
            while(rs.next()) {
                ...
                com.xichuan.generator.util.Field field = new com.xichuan.generator.util.Field();
