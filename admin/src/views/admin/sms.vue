        ...
        methods:{
            ...
            list(page){
                ...
                _this.currentPage=page,
                    _this.$ajax.post(process.env.VUE_APP_SERVER+"/business/sms/listPage",{
                        page:page,
            ...
            save(){
                ...
                Loading.show();
                _this.$ajax.post(process.env.VUE_APP_SERVER+"/business/sms/save", _this.sms).then((response=>{
                    Loading.hide();
            ...
            del(id){
                ...
                Confirm.show("删除章节不可恢复确认删除?",function (){
                    Loading.show();
                    _this.$ajax.delete(process.env.VUE_APP_SERVER+"/business/sms/delete/"+id, _this.sms).then((response=>{
                        Loading.hide();
                        // console.log("删除短信验证码列表结果：",response);
                        let resp = response.data;
                        if (resp.success){
                ...
                //         Loading.show();
                //         _this.$ajax.delete("http://127.0.0.1:9000/business/sms/delete/"+id, _this.sms).then((response=>{
                //             Loading.hide();
                //             console.log("删除短信验证码列表结果：",response);
                //             let resp = response.data;
                //             if (resp.success){
