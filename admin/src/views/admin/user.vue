        ...
        methods:{
            ...
            del(id){
                ...
                Confirm.show("删除章节不可恢复确认删除?",function (){
                    Loading.show();
                    _this.$ajax.delete(process.env.VUE_APP_SERVER+"/system/user/delete/"+id, _this.user).then((response=>{
                        Loading.hide();
                ...
                //         Loading.show();
                //         _this.$ajax.delete("http://127.0.0.1:9000/system/user/delete/"+id, _this.user).then((response=>{
                //             Loading.hide();
                //             console.log("删除用户列表结果：",response);
                //             let resp = response.data;
                //             if (resp.success){
